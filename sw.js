const CACHE = 'weight-v107-showroom-effects-profile-fit';
const ASSETS = [
  ...
  './js/today-message.js',
  './js/showroom-catalog-v2.js', './js/showroom-catalog-v4.generated.js', './js/showroom-graph-skins.js', './js/showroom-card-themes.js', './js/showroom-companions-v5.js', './js/showroom-profile-emojis-v6.js', './js/showroom-portrait-frames-v7.js', './js/titles-catalog-v2.js', './js/achievement-item-rewards-v2.js',
