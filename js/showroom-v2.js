...
function borderSignatureMarkup(s){return ({
gate:`<g class="eb-signature eb-gate" fill="none"><path data-part="left-door" d="M8 13h17v39H8zM20 18v29"/><path data-part="right-door" d="M39 13h17v39H39zM44 18v29"/><ellipse data-part="orbit-outer" cx="32" cy="32" rx="29" ry="20"/><ellipse data-part="orbit-mid" cx="32" cy="32" rx="25" ry="27"/><ellipse data-part="orbit-inner" cx="32" cy="32" rx="20" ry="13"/></g>`,
ice:`<g class="eb-signature eb-ice" fill="none"><path data-part="ice-spikes" d="M32 2l5 17 11-13-3 19 17-7-14 14 14 14-17-7 3 19-11-13-5 17-5-17-11 13 3-19-17 7 14-14L2 18l17 7-3-19 11 13z"/><path data-part="ice-crystal" d="M32 13v38M13 32h38M19 19l26 26M45 19L19 45"/></g>`,
chain:`<g class="eb-signature eb-chain" fill="none"><path data-part="chain-links" d="M14 12c-8 5-9 14-3 20l6 6m33-26c8 5 9 14 3 20l-6 6M17 38c-6 6-4 15 4 19m26-19c6 6 4 15-4 19"/><rect data-part="padlock" x="22" y="34" width="20" height="18" rx="3"/><path data-part="shackle" d="M26 34v-6a6 6 0 0 1 12 0v6"/><circle data-part="keyhole" cx="32" cy="43" r="2"/></g>`,
rune:`<g class="eb-signature eb-rune" fill="none"><ellipse data-part="orbit-a" cx="32" cy="32" rx="28" ry="18"/><ellipse data-part="orbit-b" cx="32" cy="32" rx="18" ry="28"/><path data-part="rune-n" d="M32 3l4 7-4 5-4-5z"/><path data-part="rune-e" d="M61 32l-7 4-5-4 5-4z"/><path data-part="rune-s" d="M32 61l-4-7 4-5 4 5z"/><path data-part="rune-w" d="M3 32l7-4 5 4-5 4z"/></g>`,
dragons:`<g class="eb-signature eb-dragons" fill="none"><path data-part="dragon-one" d="M32 7C12 5 4 22 10 38c4 11 15 18 25 17l-8-7 8-5-10-3c-9-3-10-15-2-20l8-4z"/><path data-part="dragon-two" d="M32 57c20 2 28-15 22-31-4-11-15-18-25-17l8 7-8 5 10 3c9 3 10 15 2 20l-8 4z"/><circle data-part="eye-one" cx="21" cy="18" r="1.5"/><circle data-part="eye-two" cx="43" cy="46" r="1.5"/></g>`,
'tentacle-eye':`<g class="eb-signature eb-tentacle-eye" fill="none"><path data-part="tentacle-one" d="M8 54C2 42 18 38 12 25S8 10 18 5"/><path data-part="tentacle-two" d="M56 54c6-12-10-16-4-29s4-15-6-20"/><path data-part="tentacle-three" d="M21 60c-8-10 5-15 1-24"/><path data-part="tentacle-four" d="M43 60c8-10-5-15-1-24"/><path data-part="rear-eye" d="M19 26q13-12 26 0-13 12-26 0z"/><ellipse data-part="pupil" cx="32" cy="26" rx="3" ry="7"/></g>`,
'machine-steam':`<g class="eb-signature eb-machine-steam" fill="none"><path data-part="octagonal-plate" d="M16 5h32l11 11v32L48 59H16L5 48V16z"/><path data-part="gear" d="M28 16h8l2 5 5-2 4 7-4 4 5 4-4 7-6-2-2 6h-8l-2-6-6 2-4-7 5-4-4-4 4-7 5 2z"/><circle data-part="hub" cx="32" cy="30" r="6"/><path data-part="steam-left" d="M13 43q-7-5 0-10t0-10"/><path data-part="steam-right" d="M51 43q7-5 0-10t0-10"/></g>`,
'roots-sprout':`<g class="eb-signature eb-roots-sprout" fill="none"><path data-part="trunk" d="M32 57V20"/><path data-part="root-left" d="M32 45Q21 48 10 58M29 50l-12 2"/><path data-part="root-right" d="M32 45q11 3 22 13m-19-8 12 2"/><path data-part="branch-left" d="M32 29Q20 25 13 13"/><path data-part="branch-right" d="M32 31q12-8 19-19"/><path data-part="leaf-left" d="M13 13q12-4 12 8-10 5-12-8z"/><path data-part="leaf-right" d="M51 12q-12-3-11 9 10 4 11-9z"/></g>`,
'wings-feather':`<g class="eb-signature eb-wings-feather" fill="none"><path data-part="left-wing" d="M29 18Q12 3 3 14l14 8-13 7 17 5-11 10 20-6z"/><path data-part="right-wing" d="M35 18Q52 3 61 14l-14 8 13 7-17 5 11 10-20-6z"/><path data-part="left-bones" d="M28 24L10 14m18 16L9 29m19 7L15 41"/><path data-part="right-bones" d="M36 24l18-10M36 30l19-1M36 36l13 5"/><path data-part="feather" d="M32 20q8 12 0 30-8-18 0-30z"/></g>`,
'throne-crown':`<g class="eb-signature eb-throne-crown" fill="none"><path data-part="throne-back" d="M18 50V23l8 6 6-17 6 17 8-6v27"/><path data-part="throne-seat" d="M14 48h36v9H14zM20 39h24v10H20z"/><path data-part="crown" d="M20 13l7 5 5-11 5 11 7-5-3 12H23z"/><circle data-part="crown-light-left" cx="20" cy="12" r="2"/><circle data-part="crown-light-center" cx="32" cy="6" r="2"/><circle data-part="crown-light-right" cx="44" cy="12" r="2"/></g>`
})[s]||''}
export function renderAmbientV2(id){const item=getCatalogItemV2(id);if(!item)return'';const i=indexInCategory(item),family=i%15,signature={ae_wind:'slash-trail',ae_astral:'time-reverse',ae_gold_sand:'loot-beam',ae_void:'rage-rift',ae_abyss:'water-shadow',ae_thunder:'record-lightning',ae_rune:'spellbook',ae_crystal:'glass-restore',ae_dust:'gravity-flip',ae_dawn_blessing:'holy-descent'}[item.id],rest=typeof location!=='undefined'&&location.pathname.endsWith('/visual-lab.html');if(signature)return `<span class="v2-ambient ambient-signature-host ${rest?'lab-rest':''}" data-state="${rest?'rest':'sequence'}" data-layout="${item.implKey}" data-signature="${signature}" style="--ambient-h:${hueFor(item)};--ambient-seed:${i}">${ambientSignatureMarkup(signature)}</span>`;const count=3+(i%8);return `<span class="v2-ambient ambient-family-${family}" data-layout="${item.implKey}" style="--ambient-h:${hueFor(item)};--ambient-seed:${i}">${Array.from({length:count},(_,n)=>`<i class="ambient-shape-${(family+n)%10}" style="--n:${n}"></i>`).join('')}</span>`}

function ambientSignatureMarkup(s){const parts={
'slash-trail':`<path data-part="slash-one" d="M8 52L44 8"/><path data-part="slash-two" d="M56 8l36 44"/><path data-part="cut-surface" d="M18 30h64"/>`,
'time-reverse':`<path data-part="clock-arc" d="M24 45a25 25 0 1 1 50-2"/><path data-part="reverse-arrow" d="M69 35l7 9 8-7"/><path data-part="clock-hand" d="M49 30V15m0 15-13 8"/><path data-part="chart-ghost" d="M8 48l17-9 12 5 17-22 13 9 24-17"/>`,
'loot-beam':`<path data-part="vertical-light" d="M38 3h24l8 48H30z"/><path data-part="chest-base" d="M31 42h38v14H31z"/><path data-part="chest-lid" d="M32 41q18-15 36 0"/><path data-part="chest-lock" d="M47 43h6v7h-6z"/>`,
'rage-rift':`<path data-part="rift-main" d="M48 2L35 20l12 3-16 14 15 2-8 19"/><path data-part="rift-left" d="M40 20L18 11m20 25L13 49"/><path data-part="rift-right" d="M47 23l27-11M45 40l36 13"/>`,
'water-shadow':`<path data-part="water-one" d="M2 16q12-8 24 0t24 0 24 0 24 0"/><path data-part="water-two" d="M2 24q12-8 24 0t24 0 24 0 24 0"/><path data-part="creature-shadow" d="M7 47q25-27 50-10l17-10-4 13 23 7-27 5Q29 66 7 47z"/>`,
'record-lightning':`<circle data-part="record-high" cx="18" cy="13" r="4"/><circle data-part="record-low" cx="48" cy="48" r="4"/><circle data-part="record-current" cx="84" cy="23" r="4"/><path data-part="bolt-one" d="M20 16l14 8-8 7 20 14"/><path data-part="bolt-two" d="M52 46l10-12 7 5 12-13"/>`,
spellbook:`<path data-part="left-page" d="M49 50Q32 38 12 45V13q20-7 37 7z"/><path data-part="right-page" d="M51 50q17-12 37-5V13q-20-7-37 7z"/><path data-part="geometry" d="M28 22l10 17H18zM66 20l10 10-10 10-10-10z"/><path data-part="book-spine" d="M50 19v32"/>`,
'glass-restore':`<path data-part="glass-frame" d="M8 5h84v50H8z"/><path data-part="crack-one" d="M51 5l-8 16 9 7-19 9 7 18"/><path data-part="crack-two" d="M52 28l18-12 4 15 16 7"/><path data-part="glass-shards" d="M18 13l14 4-8 12zM65 39l18 5-12 8z"/>`,
'gravity-flip':`<path data-part="fragment-triangle" d="M12 48l10-16 8 15z"/><rect data-part="fragment-square" x="39" y="36" width="12" height="12"/><circle data-part="fragment-circle" cx="67" cy="42" r="7"/><path data-part="fragment-diamond" d="M87 29l8 10-8 10-8-10z"/><path data-part="up-arrows" d="M18 28V8l-5 7m5-7 5 7M46 32V10l-5 7m5-7 5 7M70 33V7l-5 7m5-7 5 7"/>`,
'holy-descent':`<path data-part="open-sky" d="M15 10q18 10 35 0 17 10 35 0"/><path data-part="light-column" d="M38 12h24l14 46H24z"/><ellipse data-part="halo" cx="50" cy="25" rx="20" ry="8"/><path data-part="rays" d="M50 1v11M24 4l9 10M76 4 67 14"/>`};return s?`<svg class="ambient-signature ambient-${s}" viewBox="0 0 100 60" preserveAspectRatio="none" fill="none">${parts[s]}</svg>`:''}
...
export function renderEmojiBorderV2(id,size=52){
  ...
  const signature={eb_astral_portal:'gate',eb_frost_spikes:'ice',eb_ember_chain:'chain',eb_arcane_orbit:'rune',eb_primordial_serpent:'dragons',eb_abyss_tentacles:'tentacle-eye',eb_clockwork_dial:'machine-steam',eb_worldroot_arch:'roots-sprout',eb_drake_wings:'wings-feather',eb_dawn_throne:'throne-crown'}[item.id];const fx=borderSignatureMarkup(signature);
  return `<svg class="v2-emoji-border eb-variant-${i} ${signature?'eb-signature-host':''}" data-variant="${i}" data-layout="${item.implKey}" data-signature="${signature||''}" viewBox="0 0 64 64" width="${size}" height="${size}" aria-hidden="true"><g fill="none" stroke="${c}" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" style="color:${c}">${shapes[i]||shapes[0]}</g><circle cx="32" cy="32" r="22" fill="none" stroke="${a}" stroke-width=".8" opacity=".38"/>${fx}</svg>`;
}
