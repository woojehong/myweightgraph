...
for(const token of ['grid-template-columns:repeat(12,minmax(0,1fr))','grid-template-rows:repeat(2,22px)','justify-content:stretch','direction:rtl','object-fit:cover','aspect-ratio:4.2/1',':empty{display:none!important}','min-height:60px!important','align-self:center!important','transform:none!important'])assert.ok(css.includes(token),token);
...
assert.ok(sw.includes('weight-v151-water-record-achievements'));
