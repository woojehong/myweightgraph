...
for(const token of ['weight-v151-water-record-achievements','ambient_dynasty_hall.webp','ambient_six_star_crown.webp'])assert.ok(serviceWorker.includes(token),token);
