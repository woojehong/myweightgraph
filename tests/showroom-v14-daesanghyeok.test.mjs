...
for(const token of ['weight-v148-record-tier-recovery','ambient_dynasty_hall.webp','ambient_six_star_crown.webp'])assert.ok(serviceWorker.includes(token),token);
