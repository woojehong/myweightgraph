...
for(const token of ['weight-v147-trophy-rail-centered','ambient_dynasty_hall.webp','ambient_six_star_crown.webp'])assert.ok(serviceWorker.includes(token),token);
