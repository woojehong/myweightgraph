...
assert.ok(sw.includes("weight-v141-ambient-art-no-hard-center-clip"));assert.ok(sw.includes("c.addAll(CORE_ASSETS)"));assert.equal(sw.includes('c.addAll(ASSETS)'),false);
