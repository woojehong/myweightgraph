...
assert.ok(sw.includes("weight-v139-daesanghyeok-legendary-remaster"));assert.ok(sw.includes("c.addAll(CORE_ASSETS)"));assert.equal(sw.includes('c.addAll(ASSETS)'),false);
